...
Entrem a la ruta /etc/php/8.2/apache2 i modifiquem les següents dos lineas:
...
Per poder fer servir le projecte en la maquina virtual nomes em de crear el usuari i la base de dades com tenim en el vagrant i cambair la ip de la base de dades a la 127.0.0.1 per a ser le localhost
